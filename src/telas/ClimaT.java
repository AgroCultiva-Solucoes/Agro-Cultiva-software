 ...
 * @author Hello
 */
public class ClimaT extends javax.swing.JFrame {

    /**
     * Creates new form ClimaT
     */
    public ClimaT() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClimaT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
